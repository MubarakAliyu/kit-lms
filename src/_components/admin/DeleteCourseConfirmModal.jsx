...
import { deleteCourse } from "@/_lib/api/admin";

export default function DeleteCourseConfirmModal({ course, onClose, onDeleted }) {
        ...
        >
          ...
          >
            ...
            <p className="mt-1 text-sm text-[var(--text-secondary)]">
              This cannot be undone. All modules and lessons will be permanently
              removed.
            </p>
